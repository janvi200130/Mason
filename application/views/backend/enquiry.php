								...
								<div class="card-body">
									...
									<?php $i=1; foreach ($records as $row) {  ?>
												<tr>
													...
													<a href="javascript:void(0);" onclick="deleteEnquiry(<?php echo $row->id ?>)" class="btn btn-sm btn-danger"><i class="far fa-trash-alt"></i> Delete</a>
...
<script>
	function deleteEnquiry(id) {
		if (confirm('are you sure to delete this record')) {
			window.location.href = '<?php echo base_url() . 'admin/deleteEnquiry?id='?>' + id;
		}
	}
</script>
